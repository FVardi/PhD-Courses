...
Best parameters are saved and can be pasted into 12_xgboost_baseline.py.

Usage (CLI):
    python 11_xgboost_tune.py --trials 100
    python 11_xgboost_tune.py --trials 50 --jobs 4
...
_datasets = _load_module("datasets", "5_datasets.py")
